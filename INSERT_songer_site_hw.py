...
track_data_not_album = [
    (2, 'Голоса', 196, 4), (3, 'Падаем в небо', 155, 5), (4, 'Малиновый свет', 184, 1),
    (5, 'Focus On Me', 153, 1), (8, 'KoolSax', 305, 8), (9, 'Cruel Summer', 150, 8),
    (10, 'ЛА ЛА ЛА', 144, 1), (11, 'Услышит весь район', 120, 4),
    (13, 'The last great american dynasty', 211, 2), (16, 'Nothing But You (UK Radio Edit)', 190, 10),
    (17, 'Shivers (Original Mix)', 187, 10),  (19, 'Old Friend', 91, 1),
    (21, 'Cannot Believe The Way We Flow', 256, 1, 10)
]

for td in track_data_not_album:
    connection.execute(f"""INSERT INTO track (track_id, name_track, track_duration, genre_id)
    VALUES('{td[0]}', '{td[1]}', '{td[2]}', '{td[3]}');
""")

track_data_in_album = [
    (6, 'Безболезненно', 203, 1, 2), (7, 'Beverly Hills', 182, 1, 3), (12, 'Cardigan', 215, 2, 4),
    (14, 'Worth It', 188, 1, 5), (15, 'Lil Uzi Vert', 189, 1, 6), (18, 'Geyser', 134, 1, 7),
    (20, 'Mile High', 188, 1, 8)
]

for tda in track_data_in_album:
    connection.execute(f"""INSERT INTO track (track_id, name_track, track_duration, genre_id, track_id_is_album)
    VALUES('{tda[0]}', '{tda[1]}', '{tda[2]}', '{tda[3]}', '{tda[4]}');
""")
